...
const botFeatures: FeatureItem[] = [
  {
    ...
    text: 'Быстрое подключение Премиума и прозрачный статус доступа. Оплата доступна удобным для вас способом — без сложных шагов.',
    icon: 'checkin',
  },
  {
    title: 'Поддержка',
    text: 'Если возникают вопросы по работе сервиса, вы можете обратиться в поддержку прямо через бота и получить понятный ответ.',
    icon: 'chat',
  },
  {
    title: 'Отзывы',
    text: 'Через бота удобно делиться впечатлениями о проекте. Обратная связь помогает развивать продукт с уважением к реальному опыту пользователей.',
    icon: 'voice',
  },
  {
    title: 'Реферальная программа',
    text: 'Приглашайте друзей и делитесь проектом. Реферальный формат встроен в бот и не перегружает вас лишними действиями.',
    icon: 'chart',
  },
  {
    title: 'Новости проекта',
    text: 'В боте и канале обновлений вы видите, как развивается «ВключиСебя AI»: новые разделы, улучшения и изменения логики продукта.',
    icon: 'spark',
  },
  {
    title: 'Быстрый переход в «Путь к Себе»',
    text: 'Основной функционал перенесён в мини-приложение. Бот остаётся удобным коммуникационным и сервисным слоем вокруг продукта.',
    icon: 'card',
  },
]
        ...
        >
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mx-auto mt-8 max-w-2xl text-lg font-light leading-relaxed text-zinc-400 md:mt-10 md:text-xl md:leading-relaxed">
              «ВключиСебя AI» — экосистема психологической и эмоциональной <strong className="font-medium text-zinc-300">самоподдержки</strong>{' '}
              в Telegram. Теперь основная работа с собой происходит в мини-приложении <strong className="font-medium text-zinc-300">«Путь к Себе»</strong>,
              а бот выполняет роль коммуникационного и сервисного центра: подписка, поддержка, отзывы, реферальная программа и обновления.
              Сервис <strong className="font-medium text-zinc-300">не заменяет</strong> очную или онлайн-консультацию специалиста, но помогает
              бережно держать фокус на себе между встречами с психологом.
            </p>
              ...
              <ul className="mt-5 space-y-3.5 text-base font-light leading-relaxed text-zinc-400 md:text-lg">
                ...
                <li className="flex gap-3">
                  ...
                  <span>
                    ...
                    <strong className="font-medium text-zinc-300">бережно подготовиться</strong>, собрать мысли и прийти на встречу с более
                    ясным запросом.
                  </span>
                </li>
              </ul>
            ...
            <div className="mb-14 flex flex-col gap-8 md:mb-16 md:flex-row md:items-end md:justify-between lg:mb-20">
              <div className="max-w-xl">
                ...
                <h2 className="mt-2 font-display text-4xl font-medium tracking-tight text-white md:text-5xl lg:text-[3.25rem]">
                  За что отвечает Telegram-бот
                </h2>
              </div>
              <p className="max-w-md text-sm font-light leading-relaxed text-zinc-500 md:text-base">
                Бот теперь отвечает за сервисную часть проекта: доступ, коммуникацию и сопровождение пользователя.
              </p>
            </div>

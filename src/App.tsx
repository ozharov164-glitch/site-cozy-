...
const botFeatures: FeatureItem[] = [
  ...
  },
  {
    ...
    text: 'Короткий замер по шкалам, сохранение результата и сравнение с прошлым прохождением — чтобы замечать динамику, а не только «сегодня плохо».',
    icon: 'chart',
  },
  {
    title: 'Вдохновение',
...
const pathFeatures: FeatureItem[] = [
  {
    ...
    text: 'Расширенная библиотека диагностик: тревога, выгорание, самооценка и другие темы. Каждый проход сохраняется — можно вернуться к формулировкам и сравнить с прошлым собой.',
    icon: 'chart',
    tone: 'twilight',
  },
  {
    title: 'Нейро-Арена',
    text: 'Лёгкие тренажёры внимания и интерпретации в игровом формате — не «ещё работа», а короткая пауза для мозга с ощущением маленькой победы.',
    icon: 'spark',
    tone: 'twilight',
  },
  {
  ...
  {
    title: 'К специалисту',
    text: 'Структурированная подготовка к приёму у живого психолога или коуча: с чем приходите, что важно, какие ожидания. На выходе — аккуратный текст или PDF, чтобы не начинать с нуля в кабинете.',
    icon: 'doc',
    tone: 'twilight',
  },
  {
      ...
      <div className="grid gap-10 lg:grid-cols-2 lg:gap-14">
        <div>
          ...
          <p className="mt-5 text-base font-light leading-relaxed text-zinc-400 md:text-lg">
            ...
            с вашим аккаунтом в боте: данные не разъезжаются между вкладками.
          </p>
          <p className="mt-5 text-base font-light leading-relaxed text-zinc-400 md:text-lg">
            Здесь удобно возвращаться к себе <strong className="font-medium text-zinc-200">регулярно</strong> — не раз в месяц «вспомнить
            про заботу о себе», а понемногу, в своём темпе: открыли приложение, прошли чек-ин мысли, сделали практику, зафиксировали
            инсайт для Венеры или для приёма у психолога.
          </p>
        </div>
          ...
          <ul className="mt-8 space-y-4 text-sm font-light leading-relaxed text-zinc-400 md:text-base">
            ...
            <li className="flex gap-3">
              ...
              <span>
                ...
                практики — и не предлагает «универсальных советов из интернета».
              </span>
            </li>
          </ul>
        </div>
        ...
        >
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mx-auto mt-8 max-w-2xl text-lg font-light leading-relaxed text-zinc-400 md:mt-10 md:text-xl md:leading-relaxed">
              ...
              на базе ИИ: с чек-инами, тестами и бережными формулировками. Мы не заменяем очную или онлайн-консультацию специалиста —
              особенно при острых состояниях и риске для себя или других. Мы даём структуру и тепло в повседневности, чтобы вам было чуть
              легче дышать между сессиями с живым человеком.
            </p>
          </div>
        </section>
            ...
            <div className="path-spotlight path-spotlight-glow relative mb-16 rounded-[1.75rem] border border-white/[0.06] bg-gradient-to-br from-zinc-900/80 via-[#0a0814] to-zinc-950/90 p-px md:mb-20 md:rounded-[2rem]">
              <div className="relative overflow-hidden rounded-[1.7rem] bg-gradient-to-br from-teal-900/[0.12] via-transparent to-violet-950/[0.14] px-8 py-12 md:rounded-[1.95rem] md:px-12 md:py-14 lg:p-16">
                ...
                <p className="relative mt-6 max-w-2xl text-lg font-light leading-relaxed text-zinc-400 md:mt-8 md:text-xl">
                  Откройте бота, оформите Премиум при желании — и перенеситесь в интерфейс, где сочетаются научно-ориентированные тесты,
                  телесные практики и ИИ-Венера, которая помнит ваш контекст. Это не волшебная таблетка — это{' '}
                  <strong className="font-medium text-zinc-300">инструментарий</strong>, который остаётся с вами между встречами с
                  психологом.
                </p>
                <a
                  href={BOT}
          ...
          <div className="mx-auto max-w-4xl text-center">
            ...
            <div className="mt-14 grid gap-6 text-left md:mt-16 md:grid-cols-2 md:gap-8">
              ...
              <div className="group relative overflow-hidden rounded-2xl border border-teal-300/20 bg-gradient-to-b from-teal-950/[0.15] via-zinc-950/50 to-zinc-950 p-8 shadow-[0_28px_64px_-24px_rgba(126,201,184,0.15)] transition-shadow duration-500 hover:shadow-[0_32px_72px_-20px_rgba(184,169,217,0.18)] md:rounded-3xl md:p-10">
                ...
                <p className="relative mt-2 text-sm text-zinc-500">Для тех, кто хочет углубиться без лимитов в чате и с полным приложением</p>
                <ul className="relative mt-8 space-y-4">
                  <ListItem>Безлимитная ИИ-поддержка в чате</ListItem>
                  <ListItem>Полный доступ к «Пути к Себе» и Венере</ListItem>
        ...
        <section className="px-6 py-24 md:px-10 md:py-28 lg:px-12">
          <div className="relative mx-auto max-w-3xl overflow-hidden rounded-[1.75rem] border border-white/[0.1] bg-gradient-to-b from-violet-950/30 via-[#0a0a10] to-zinc-950/95 px-8 py-16 text-center shadow-[0_32px_80px_-40px_rgba(0,0,0,0.9)] md:rounded-[2rem] md:px-12 md:py-20">
            ...
            <p className="relative mx-auto mt-6 max-w-md text-base font-light leading-relaxed text-zinc-400 md:text-lg">
              Бот откроется в Telegram — дальше подскажем онбординг и подберём комфортный темп. Венера и «Путь к Себе» ждут вас там, где
              вам уже привычно быть в переписке.
            </p>
            <a
              href={BOT}
              target="_blank"

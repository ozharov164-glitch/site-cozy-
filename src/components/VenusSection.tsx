        ...
        <div className="grid items-center gap-14 lg:grid-cols-[minmax(0,1.05fr)_minmax(0,0.95fr)] lg:gap-16">
          <div className="order-2 text-center lg:order-1 lg:text-left">
            ...
            <p className="mx-auto mt-5 max-w-xl text-base font-light leading-relaxed text-zinc-400 lg:mx-0 lg:max-w-none lg:text-lg">
              Она подхватывает вас после диагностик, помогает разложить по полочкам то, что у вас крутится в голове, и предлагает{' '}
              <span className="text-teal-200/90">следующий маленький шаг</span> — такой, который вы реально можете сделать сегодня. В диалоге
              вы можете говорить от души о страхах, усталости, отношениях с собой и с близкими — и чувствовать, что вас не оценивают, а
              слышат.
            </p>
            ...
            <blockquote className="glass-quote quote-reading mx-auto mt-10 max-w-xl rounded-r-2xl px-6 py-5 text-left lg:mx-0">
              <p className="text-xl font-normal italic leading-snug text-zinc-200 md:text-2xl">
                «Как будто наконец вам можно выдохнуть вслух — и не бояться, что ответят шаблоном.»
              </p>
          ...
          <div className="order-1 flex justify-center lg:order-2 lg:justify-end">
            ...
            >
              <div
                ...
                aria-hidden
              />
              <div className="venus-halo relative mx-auto aspect-square w-full max-w-[min(100%,360px)] overflow-hidden rounded-full border border-white/12 bg-[#07070d] p-[3px] shadow-2xl lg:mx-0 lg:ml-auto">
                <div className="venus-portrait-inner aspect-square h-full w-full">
                  <img
                    src={assetUrl('ai-venus.png')}
                    alt="ИИ-Венера — персональный коуч в мини-приложении «Путь к Себе»"
                    width={760}
                    height={760}
                    className="venus-portrait-img absolute left-1/2 top-1/2 h-[118%] w-[118%] max-w-none -translate-x-1/2 -translate-y-[50.5%] object-cover object-[center_12%]"
                    decoding="async"
                    loading="lazy"
                  />
                  {/* гасим «прямоугольник» исходника и блики по кругу */}
                  <div
                    className="pointer-events-none absolute inset-0 rounded-full shadow-[inset_0_0_52px_26px_rgba(7,7,13,0.92),inset_0_0_100px_44px_rgba(7,7,13,0.48)]"
                    aria-hidden
                  />
                  <div className="pointer-events-none absolute inset-0 rounded-full bg-gradient-to-t from-[#07070d]/96 via-transparent to-[#07070d]/38" />
                </div>
              </div>
              {!reduce && (
                <motion.div

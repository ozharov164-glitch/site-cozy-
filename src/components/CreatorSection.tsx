      ...
      <div className="relative z-10 mx-auto max-w-6xl">
        <div className="grid items-center gap-12 lg:grid-cols-[minmax(0,0.95fr)_minmax(0,1.05fr)] lg:gap-16">
          ...
          <div className="relative z-10 order-1 text-center lg:order-2 lg:text-left">
            ...
            <p className="mx-auto mt-5 max-w-xl text-base font-light leading-relaxed text-zinc-400 lg:mx-0 lg:max-w-none md:text-lg">
              Если вам показалось, что проект на время «пропал», это было не молчание ради паузы. В этот период я перестраивал
              концептуальную логистику продукта: вынес основной путь пользователя в мини-приложение «Путь к Себе», а боту оставил
              сервисную и коммуникационную роль, чтобы система стала проще, яснее и надёжнее.
            </p>
            <p className="mx-auto mt-5 max-w-xl text-base font-light leading-relaxed text-zinc-400 lg:mx-0 lg:max-w-none md:text-lg">

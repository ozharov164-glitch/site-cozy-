    ...
    <>
      ...
      <header
        className={`fixed left-0 right-0 top-0 z-[70] transition-[background-color,backdrop-filter,border-color,box-shadow] duration-500 ${
          scrolled
            ? 'border-b border-white/[0.08] bg-[#07070d]/92 shadow-[0_8px_32px_-8px_rgba(0,0,0,0.65)] backdrop-blur-xl backdrop-saturate-150'
            : 'border-b border-transparent bg-[#07070d]/55 backdrop-blur-md'
        }`}
      >
        <div className="mx-auto flex h-[3.25rem] max-w-7xl items-center justify-between gap-3 px-4 sm:h-16 sm:px-6 md:px-10 lg:px-12">
          <a
            href="#top"
            className="group flex shrink-0 items-center gap-2.5 focus:outline-none focus-visible:ring-2 focus-visible:ring-teal-400/50 focus-visible:ring-offset-2 focus-visible:ring-offset-[#07070d]"
          >
          ...
          <a
            ...
            className="group relative inline-flex shrink-0 items-center justify-center overflow-hidden rounded-full px-4 py-2 text-[0.8125rem] font-semibold text-[#0a1210] shadow-[0_0_24px_-6px_rgba(126,201,184,0.4)] focus:outline-none focus-visible:ring-2 focus-visible:ring-violet-400/55 focus-visible:ring-offset-2 focus-visible:ring-offset-[#07070d] sm:px-5 sm:text-sm"
          >
